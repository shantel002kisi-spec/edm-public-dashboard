...
if "Key results from the dissertation poster" in text:
    print("Poster results already added.")
    raise SystemExit(0)
...
if marker not in text:
    raise SystemExit("Could not find PAGE 2 marker")
...
print("Poster-aligned results added to Start here.")
